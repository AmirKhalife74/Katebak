...
import com.example.katebak.data.models.NoInternetModel
import com.example.katebak.utils.Env.selectedChipColor
...
fun convertPersianToLatinNumbers(input: String): String {
    val persianToLatinMap = mapOf(
        '۰' to '0',
        '۱' to '1',
        '۲' to '2',
        '۳' to '3',
